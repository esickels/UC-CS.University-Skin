...
<div class="cs-wrapper">
	...
	<div class="cs-center">
		...
		<div class="cs-right-column">
			<div class="cs-right-column-in-right">
				<div class="pane" id="RightPane" runat="server"></div>
			</div>
            <div class="cs-left-column-in-right">
